        ...
        <section className=' w-full h-[100vh] flex justify-center items-center  bg-center z-0 inline-grid' id='head'>
          <div class='self-right self-baseline text-white pointer mr-[11px] pt-[11px]'>
            <ul class='flex justify-end'>
              <li class='w-fit mr-[20px] cursor-pointer'><a href=""><FontAwesomeIcon icon={faGithub} size="2xl" className='w-[25px]'/></a></li>
              <li class='w-fit mr-[20px] cursor-pointer'><a href=""><FontAwesomeIcon icon={faLinkedin} size="2xl" className='w-[25px]'/></a></li>
            </ul>
          </div>
